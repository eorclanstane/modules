...
class GitaddMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig("GH_TOKEN", "980b09c67bb3a4e280b99fd7eef04b7804b38434", lambda m: self.strings("cfg_token", m),
            "GH_USERNAME", "eorclanstane", lambda m: self.strings("cfg_gh_user", m),
